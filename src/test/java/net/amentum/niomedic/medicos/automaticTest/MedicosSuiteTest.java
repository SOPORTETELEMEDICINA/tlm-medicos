package net.amentum.niomedic.medicos.automaticTest;
...
public class MedicosSuiteTest extends MedicoTestConfiguration{
	...
	public void crearMedico() throws Exception {
		...
		medicoView.setApellidoPaterno("setApellidoPaterno");

		medicoView.setApellidoMaterno("setApellidoMaterno");
		SimpleDateFormat sdf = new SimpleDateFormat("dd/M/yyyy");
		String dateS = "14/09/1976";
		Date dateD = sdf.parse(dateS);
		medicoView.setFechaNacimiento(dateD);
		medicoView.setLugarNacimiento("setLugarNacimiento");
		medicoView.setEstadoCivil("setEstadoCivil");
		medicoView.setSexo("setSexo");
		medicoView.setCurp("setCurp"+id);
		medicoView.setRfc("setRfc"+id);
		medicoView.setEmail("setEmail");
		medicoView.setTelefonoFijo("setTelefonoFijo");
		medicoView.setTelefonoMovil("setTelefonoMovil");
		//medicoView.setIdUsuario(369L+id);
		medicoView.setActivo(Boolean.TRUE);
		medicoView.setUserName("setUserName"+id);
		medicoView.setFechaCreacion(new Date());

		DomicilioView domicilioView = new DomicilioView();
		domicilioView.setDomicilio("setDomicilio");
		...
		domicilioView.setRegistroSanitario("setRegistroSanitario");
		domicilioView.setTelefonoFijo("setTelefonoFijo");
		domicilioView.setFechaCreacion(new Date());
		domicilioView.setActivo(Boolean.TRUE);
		domicilioView.setTipo("setTipo");

		DomicilioView domicilioView2 = new DomicilioView();
		domicilioView2.setDomicilio("setDomicilio");
		domicilioView2.setLocalidad("setLocalidad");
		domicilioView2.setMunicipio("setMunicipio");
		domicilioView2.setEstado("setEstado");
		domicilioView2.setPais("setPais");
		domicilioView2.setCp("setCp");
		domicilioView2.setRegistroSanitario("setRegistroSanitario");
		domicilioView2.setTelefonoFijo("setTelefonoFijo");
		domicilioView2.setFechaCreacion(new Date());
		domicilioView2.setActivo(Boolean.TRUE);
		domicilioView2.setTipo("setTipo");
		...
		especialidadView.setNombreImagenCedula("EP-imagen-cedula");
		especialidadView.setNombreImagenDiploma("EP-imagen-diploma");
		especialidadView.setValidado(Boolean.TRUE);
		especialidadView.setFechaCreacion(new Date());
		dateS = "21/12/1976";
		dateD = sdf.parse(dateS);
		especialidadView.setFechaValidacion(dateD);

		EspecialidadView especialidadView2 = new EspecialidadView();
		especialidadView2.setEspecialidad("setEspecialidad");
		especialidadView2.setUniversidad("setUniversidad");
		especialidadView2.setCedula("setCedula");

		especialidadView2.setImgCedula64("data:image/png;base64,");
		especialidadView2.setImgTitulo64("data:image/png;base64,");

		especialidadView2.setValidado(Boolean.TRUE);
		especialidadView2.setFechaCreacion(new Date());
		dateS = "21/12/1977";
		dateD = sdf.parse(dateS);
		especialidadView2.setFechaValidacion(dateD);

		ArrayList<EspecialidadView> especialidadViewArrayList = new ArrayList<>();
		especialidadViewArrayList.add(especialidadView);
		especialidadViewArrayList.add(especialidadView2);
		medicoView.setEspecialidadViewList(especialidadViewArrayList);
		///////////////////////////////////////////// DATOS GENERICOS

		System.out.println(MAPPER.writeValueAsString(medicoView));

		mockMvc.perform(MockMvcRequestBuilders.post("/medicos")
				.contentType(JSON)
				.content(MAPPER.writeValueAsString(medicoView)))
	...
	public void getMedico() throws Exception {
		String respuesta=crearMedicoParaTest();
		MedicoView resultView = MAPPER.readValue(respuesta, new TypeReference<MedicoView>(){});
		mockMvc.perform(MockMvcRequestBuilders.get("/medicos/{idMedico}",resultView.getIdMedico())
				.contentType(JSON))
	...
	public void updateMedico() throws Exception {
		...
		MedicoView medicoView = new MedicoView();
		medicoView.setNombre("MP-Nombre-U");
		medicoView.setApellidoPaterno("MP-Apellido Paterno-U");
		medicoView.setApellidoMaterno("MP-Apellido Materno-U");
		SimpleDateFormat sdf = new SimpleDateFormat("dd/M/yyyy");
		String dateS = "14/09/1976";
		Date dateD = sdf.parse(dateS);
		medicoView.setFechaNacimiento(dateD);
		medicoView.setLugarNacimiento("MP-lugar-de-nacimiento");
		medicoView.setEstadoCivil("MP-Estado Civil-U");
		medicoView.setSexo("MP-Sexo-U");
		medicoView.setCurp("MP-CURP-U"+id);
		medicoView.setRfc("MP-RFC-U"+id);
		medicoView.setEmail("MP-Email-U"+id);
		medicoView.setTelefonoFijo("MP-Telefono Oficina-U");
		medicoView.setTelefonoMovil("MP-Telefono Celular-U");

		
		medicoView.setActivo(Boolean.FALSE);
		medicoView.setUserName("username"+id);
		medicoView.setFechaCreacion(new Date());
		DomicilioView domicilioView = new DomicilioView();
		domicilioView.setIdDomicilio("65db925c-5f3d-4537-8d95-5d52c4d933fd");
		domicilioView.setDomicilio("Puerto Madero #204-U");
		domicilioView.setLocalidad("Real del Valle");
		...
		domicilioView.setFechaCreacion(new Date());
		domicilioView.setActivo(Boolean.TRUE);
		domicilioView.setTipo("Consultorio privado");
		DomicilioView domicilioView2 = new DomicilioView();
		domicilioView2.setIdDomicilio("c275bece-df10-4a84-b9d0-8aa76cea68fc");
		domicilioView2.setDomicilio("Corredor del Puerto #693-U");
		domicilioView2.setLocalidad("Villas del Corredor");
		...
		domicilioView2.setTelefonoFijo("DP-telefono-fijo");
		domicilioView2.setRegistroSanitario("DP-registro-sanitario");
		domicilioView2.setFechaCreacion(new Date());
		domicilioView2.setActivo(Boolean.TRUE);
		domicilioView2.setTipo("Hospital BuenoDoctor");
		ArrayList<DomicilioView> domicilioViewArrayList = new ArrayList<>();
		domicilioViewArrayList.add(domicilioView);
		domicilioViewArrayList.add(domicilioView2);
		medicoView.setDomicilioViewList(domicilioViewArrayList);
		EspecialidadView especialidadView = new EspecialidadView();
		especialidadView.setIdEspecialidad("65db925c-5f3d-4537-8d95-5d52c4d933fd");
		especialidadView.setEspecialidad("EP-especilidad");
		especialidadView.setUniversidad("EP-universidad");
		especialidadView.setCedula("EP-cedula");
		especialidadView.setNombreImagenCedula("EP-imagen-cedula");
		especialidadView.setNombreImagenDiploma("EP-imagen-diploma");
		especialidadView.setValidado(Boolean.TRUE);
		especialidadView.setFechaCreacion(new Date());
		...
		medicoView.setIdUsuario(id.longValue());
		medicoView.setIdUsuarioZoom(id+"");
		System.out.println(MAPPER.writeValueAsString(medicoView));
		
		mockMvc.perform(MockMvcRequestBuilders.put("/medicos/{idMedico}",resultView.getIdMedico())
				.contentType(JSON)
				.content(MAPPER.writeValueAsString(medicoView)))
		.andExpect(MockMvcResultMatchers.status().isOk())
		.andDo(MockMvcResultHandlers.print());
	...
	public String crearMedicoParaTest() throws Exception {
		...
		String jsonResponse=mockMvc.perform(MockMvcRequestBuilders.post("/medicos")
				.contentType(JSON)
				.content(MAPPER.writeValueAsString(medicoView)))
		.andExpect(MockMvcResultMatchers.status().isCreated())
