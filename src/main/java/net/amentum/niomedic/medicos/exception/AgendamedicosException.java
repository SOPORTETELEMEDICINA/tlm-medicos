...
public class AgendamedicosException extends GenericException {
    ...
    public AgendamedicosException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public AgendamedicosException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
