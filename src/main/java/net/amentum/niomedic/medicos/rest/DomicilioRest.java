...
public class DomicilioRest {
   ...
   @RequestMapping(value = "{idMedico}/domicilio", method = RequestMethod.POST)
   @ResponseStatus(HttpStatus.CREATED)
   public void createDomicilio(@PathVariable() String idMedico, @RequestBody @Valid ArrayList<DomicilioView> domicilioViewArrayList) throws DomicilioException {
      try {
         logger.info("===>>>Guardar nuevo domicilio: {}", domicilioViewArrayList);
         domicilioService.createDomicilio(domicilioViewArrayList, idMedico);
   ...
   @RequestMapping(value = "{idMedico}/domicilio",method = RequestMethod.PUT)
   @ResponseStatus(HttpStatus.OK)
   public void updateDomicilio(@PathVariable()String idMedico, @RequestBody @Valid ArrayList<DomicilioView> domicilioViewArrayList) throws DomicilioException {
      try{
         logger.info("===>>>Modificar domicilio: {}", domicilioViewArrayList);
         domicilioService.updateDomicilio(domicilioViewArrayList,idMedico);
      }catch (DomicilioException dome){
         throw dome;
      }catch(Exception ex){
         ...
         logger.error("===>>>Error al modificar domicilio- CODE: {} - ",dome.getExceptionCode(),ex);
         throw dome;
      }
   }

   @RequestMapping(value = "{idMedico}/domicilio",method = RequestMethod.DELETE)
   @ResponseStatus(HttpStatus.OK)
   public void deleteDomicilio(@PathVariable()String idMedico, @RequestBody @Valid ArrayList<DomicilioView> domicilioViewArrayList) throws DomicilioException {
      try{
         logger.info("===>>>Borrar domicilio: {}", domicilioViewArrayList);
         domicilioService.deleteDomicilio(domicilioViewArrayList,idMedico);
      }catch (DomicilioException dome){
         throw dome;
      }catch(Exception ex){
